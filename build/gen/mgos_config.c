...
const struct mgos_conf_entry mgos_config_schema_[220] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 219},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "ssd1306", .offset = offsetof(struct mgos_config, ssd1306), .num_desc = 10},
  {.type = CONF_TYPE_BOOL, .key = "enable", .offset = offsetof(struct mgos_config, ssd1306.enable)},
  {.type = CONF_TYPE_INT, .key = "width", .offset = offsetof(struct mgos_config, ssd1306.width)},
  {.type = CONF_TYPE_INT, .key = "height", .offset = offsetof(struct mgos_config, ssd1306.height)},
  {.type = CONF_TYPE_INT, .key = "address", .offset = offsetof(struct mgos_config, ssd1306.address)},
  {.type = CONF_TYPE_OBJECT, .key = "i2c", .offset = offsetof(struct mgos_config, ssd1306.i2c), .num_desc = 5},
  {.type = CONF_TYPE_BOOL, .key = "enable", .offset = offsetof(struct mgos_config, ssd1306.i2c.enable)},
  {.type = CONF_TYPE_INT, .key = "freq", .offset = offsetof(struct mgos_config, ssd1306.i2c.freq)},
  {.type = CONF_TYPE_BOOL, .key = "debug", .offset = offsetof(struct mgos_config, ssd1306.i2c.debug)},
  {.type = CONF_TYPE_INT, .key = "sda_gpio", .offset = offsetof(struct mgos_config, ssd1306.i2c.sda_gpio)},
  {.type = CONF_TYPE_INT, .key = "scl_gpio", .offset = offsetof(struct mgos_config, ssd1306.i2c.scl_gpio)},

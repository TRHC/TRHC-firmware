 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/latest/apps/MongooseApp/esp8266/build_contexts/build_ctx_341131318/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /fwbuild-volumes/latest/apps/MongooseApp/esp8266/build_contexts/build_ctx_341131318/build/gen/mos_conf_schema.yml
 */
...
struct mgos_config_ssd1306_i2c {
  int enable;
  int freq;
  int debug;
  int sda_gpio;
...
struct mgos_config_ssd1306 {
  int enable;
  int width;
  int height;
  int address;
  struct mgos_config_ssd1306_i2c i2c;
};
...
struct mgos_config {
  ...
  struct mgos_config_ssd1306 ssd1306;
...
const struct mgos_config_ssd1306 *mgos_config_get_ssd1306(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_enable(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_width(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_height(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_address(struct mgos_config *cfg);
const struct mgos_config_ssd1306_i2c *mgos_config_get_ssd1306_i2c(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_i2c_enable(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_i2c_freq(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_i2c_debug(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_i2c_sda_gpio(struct mgos_config *cfg);
int         mgos_config_get_ssd1306_i2c_scl_gpio(struct mgos_config *cfg);
...
void mgos_config_set_ssd1306_enable(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_width(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_height(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_address(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_i2c_enable(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_i2c_freq(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_i2c_debug(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_i2c_sda_gpio(struct mgos_config *cfg, int         val);
void mgos_config_set_ssd1306_i2c_scl_gpio(struct mgos_config *cfg, int         val);
...
static inline const struct mgos_config_ssd1306 *mgos_sys_config_get_ssd1306(void) { return mgos_config_get_ssd1306(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_enable(void) { return mgos_config_get_ssd1306_enable(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_width(void) { return mgos_config_get_ssd1306_width(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_height(void) { return mgos_config_get_ssd1306_height(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_address(void) { return mgos_config_get_ssd1306_address(&mgos_sys_config); }
static inline const struct mgos_config_ssd1306_i2c *mgos_sys_config_get_ssd1306_i2c(void) { return mgos_config_get_ssd1306_i2c(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_i2c_enable(void) { return mgos_config_get_ssd1306_i2c_enable(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_i2c_freq(void) { return mgos_config_get_ssd1306_i2c_freq(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_i2c_debug(void) { return mgos_config_get_ssd1306_i2c_debug(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_i2c_sda_gpio(void) { return mgos_config_get_ssd1306_i2c_sda_gpio(&mgos_sys_config); }
static inline int         mgos_sys_config_get_ssd1306_i2c_scl_gpio(void) { return mgos_config_get_ssd1306_i2c_scl_gpio(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_ssd1306_enable(int         val) { mgos_config_set_ssd1306_enable(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_width(int         val) { mgos_config_set_ssd1306_width(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_height(int         val) { mgos_config_set_ssd1306_height(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_address(int         val) { mgos_config_set_ssd1306_address(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_i2c_enable(int         val) { mgos_config_set_ssd1306_i2c_enable(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_i2c_freq(int         val) { mgos_config_set_ssd1306_i2c_freq(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_i2c_debug(int         val) { mgos_config_set_ssd1306_i2c_debug(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_i2c_sda_gpio(int         val) { mgos_config_set_ssd1306_i2c_sda_gpio(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_ssd1306_i2c_scl_gpio(int         val) { mgos_config_set_ssd1306_i2c_scl_gpio(&mgos_sys_config, val); }
